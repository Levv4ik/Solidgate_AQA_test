...
public class PaymentRequestBodyTemplates {

    public static PaymentRequest getDefaultPaymentRequest() {
        return PaymentRequest.builder()
                .order(PaymentRequest.Order.builder()
                        .order_id("34")
                        .amount(1020)
                        .currency("EUR")
                        ...
                        .settle_interval(0)
                        .force3ds(false)
                        .google_pay_allowed_auth_methods(Arrays.asList("PAN_ONLY"))
                        ...
                        .order_metadata(PaymentRequest.OrderMetadata.builder()
                                .coupon_code("NY2024")
                                .partner_id("123989")
                                .build())
                        ...
                        .build())
                .page_customization(PaymentRequest.PageCustomization.builder()
                        .public_name("Public Name")
                        .order_title("Order Title")
                        .order_description("Premium package")
                        .payment_methods(Arrays.asList("paypal"))
